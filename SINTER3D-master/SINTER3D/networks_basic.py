...
class DeconvNet(nn.Module):
    ...
    def __init__(self, 
        ...
        # Avoid hidden_dims index overflow
    ...
    def inference_encoder(self, coord):
        """
        Encoder method dedicated to inference; accepts coordinates directly as input.
        """
        coord_normalized = coord / 100  # Keep normalization consistent with training
